...
interface DeferredMatchOutcome {
...
declare class ViaLinkWebSDK {
    ...
    deferredMatch(): Promise<DeferredMatchOutcome>;
...
export { BannerManager, type BannerOptions, type CreateLinkExtraOptions, type DeepLinkData, type DeferredError, type DeferredMatchOutcome, type DeferredMatchResult, type EventPayload, EventTracker, NetworkClient, type PaymentInitiatedArgs, type PaymentInitiatedResult, type Platform, type ViaLinkConfig, ViaLinkWebSDK };
